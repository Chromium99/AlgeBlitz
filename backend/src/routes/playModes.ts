...
export default async function playMode(server:FastifyInstance)
{
    ...
    server.get<{ Params: {  uid: string } }>('/playmode/blitz/:uid', async (request, reply) => {
        try {
    ...
    server.post<{Body:{uid: string, score:string}}>('/playmode/blitz', async (request, reply)=>{
        ...
        try{
            ...
            return reply.send(`The following information has been uploaded/updated in the blitz table of the database: ${uid} and ${score}`)
        }
        catch(error){
    ...
    server.get<{ Params: {  uid: string } }>('/playmode/survival/:uid', async (request, reply) => {
        try {
    ...
    server.post<{Body:{uid: string, score:string}}>('/playmode/survival', async (request, reply)=>{
        const {uid, score}=request.body;
        try{
            ...
            return reply.send(`The following information has been uploaded/updated in the survival table of the database: ${uid} and ${score}`)
        }
        catch(error){
    ...
    server.get<{ Params: {  uid: string } }>('/playmode/rampUp/:uid', async (request, reply) => {
        try {
    ...
    server.post<{Body:{uid: string, score:string}}>('/playmode/rampUp', async (request, reply)=>{
        const {uid, score}=request.body;
        try{
            ...
            return reply.send(`The following information has been uploaded/updated in the rampUp table of the database: ${uid} and ${score}`)
        }
        catch(error){
            return reply.send(`Error: ${error}`)
        }
    ...
    server.get<{ Params: {  uid: string } }>('/playmode/puzzle/:uid', async (request, reply) => {
        try {
    ...
    server.post<{Body:{uid: string, score:string}}>('/playmode/puzzle', async (request, reply)=>{
        const {uid, score}=request.body;
        try{
            ...
            return reply.send(`The following information has been uploaded/updated in the puzzle table of the database: ${uid} and ${score}`)
        }
        catch(error){
            return reply.send(`Error: ${error}`)
        }
